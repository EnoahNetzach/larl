...
internal class TypeScriptPrinterTest : BaseMockingTest {
    private lateinit var printer: TypeScriptPrinter

    @BeforeEach
    fun setUp() {
        printer = mock(TypeScriptPrinter::class.java)
    ...
    fun `should print the expected module`() {
        ...
        val expected = this::class.java.getResource("/org/larl/printer/TypeScriptPrinterTest/expectedModule.txt").readText()
