...
internal class JavaScriptPrinterTest : BaseMockingTest {
    private lateinit var printer: JavaScriptPrinter

    @BeforeEach
    fun setUp() {
        printer = mock(JavaScriptPrinter::class.java)
    ...
    fun `should print the expected module`() {
        ...
        val expected = this::class.java.getResource("/org/larl/printer/JavaScriptPrinterTest/expectedModule.txt").readText()
