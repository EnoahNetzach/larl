...
internal class LuaPrinterTest : BaseMockingTest {
    private lateinit var printer: LuaPrinter

    @BeforeEach
    fun setUp() {
        printer = mock(LuaPrinter::class.java)
    ...
    fun `should print the expected module`() {
        ...
        val expected = this::class.java.getResource("/org/larl/printer/LuaPrinterTest/expectedModule.txt").readText()
