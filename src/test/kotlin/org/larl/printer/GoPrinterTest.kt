...
internal class GoPrinterTest : BaseMockingTest {
    private lateinit var printer: GoPrinter

    @BeforeEach
    fun setUp() {
        printer = mock(GoPrinter::class.java)
    ...
    fun `should print the expected module`() {
        ...
        val expected = this::class.java.getResource("/org/larl/printer/GoPrinterTest/expectedModule.txt").readText()
