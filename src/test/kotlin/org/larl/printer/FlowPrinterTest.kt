...
internal class FlowPrinterTest : BaseMockingTest {
    private lateinit var printer: FlowPrinter

    @BeforeEach
    fun setUp() {
        printer = mock(FlowPrinter::class.java)
    ...
    fun `should print the expected module`() {
        ...
        val expected = this::class.java.getResource("/org/larl/printer/FlowPrinterTest/expectedModule.txt").readText()
